...
const skills = [
  ...
  { name: ".NET Core Web API", level: 90, category: "frameworks" },
  { name: "ASP.NET MVC", level: 85, category: "frameworks" },
  ...
  // skills
  { name: "Data Structures and Algorithms", level: 95, category: "skills" },
  { name: "Low Level Design", level: 75, category: "skills" },
  { name: "Operating System", level: 75, category: "skills" },
];
